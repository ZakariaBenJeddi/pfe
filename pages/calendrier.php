...
$sql_modls = "SELECT id_matiere, nom_matiere ,code_matiere FROM matiere ORDER BY code_matiere";
                                    ...
                                    <form action="" method="get" id="matiere-form">
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-select form-select-sm text-sm" name="matiere_id" id="matiere-select">
                                                ...
                                                <?php foreach ($modls as $matiere) : ?>
                                                    <option value="<?= $matiere['nom_matiere'] ?>"><?= $matiere['code_matiere'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group mb-2">
