...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['edit'])) {
  ...
  try {
    ...
    echo "Erreur lors de la modification de la filière : " . $e->getMessage();
  }
}
