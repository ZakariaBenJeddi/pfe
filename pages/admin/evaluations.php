          ...
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex flex-wrap justify-content-between align-items-center text-center text-md-start">
              ...
              <div class="d-flex flex-column flex-md-row justify-content-center justify-content-md-end align-items-center gap-2 w-100">
                ...
                <a class="btn btn-primary btn-sm" href="ajouter_absence.php">Ajouter Absence</a>
            ...
            <?php if (count($results) > 0) { ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-3 mb-4">
                                <div class="card evaluation-card status-<?= htmlspecialchars($result->statut) ?>">
                                    <div class="card-body position-relative">
                                        ...
                                        <h5 class="card-title text-xs font-weight-bold"><?= htmlspecialchars($result->titre)." ".htmlspecialchars($result->id) ?></h5>
                                        ...
                                        <div class="mt-3 d-flex">
                                            ...
                                            <a href="evaluation.php?id=<?= $result->id ?>&del=1" class="btn btn-xs btn-danger px-2 ms-1" onClick="return confirm('Etes-vous sûr que vous voulez supprimer?')">
                    ...
                    <?php } else { ?>
                        <div class="text-center py-5">
                            ...
                            <a href="add_evaluation.php" class="btn btn-primary mt-2">
