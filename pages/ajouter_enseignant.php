...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['ajouter'])) {
  ...
  VALUES (
      :nom_enseignant,:prenom_enseignant,:email_enseignant,:telephone_enseignant,:date_naissance,:specialite,:masse_horaire,
      :date_embauche,:adresse,:genre,:niveau_education,:salaire,:est_connecte,:degree
  )";
