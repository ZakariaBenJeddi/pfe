            ...
            if (response.status === 'success' && response.count > 0) {
              ...
              response.data.forEach(function(enseignant) {
                tableBody.append(`
                                <tr>
                                    <td  class="align-middle text-center text-sm">
                                      <p class="text-xs font-weight-bold mb-0">${enseignant.nom_enseignant} ${enseignant.prenom_enseignant}</p>
                                      <div class="d-flex px-2 py-1">
                                        <div>
                                          <img src="../assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user1">
                                        </div>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                      <div class="d-flex align-items-center justify-content-center">
                                          <span class="me-2 text-xs font-weight-bold">${enseignant.degree} %</span>
                                          <div>
                                            <div class="progress">
                                              <div class="progress-bar 
                                                <?php if ($enseignant->degree <= 30) {
                                                  echo 'bg-gradient-danger';
                                                }
                                                if ($enseignant->degree <= 50 && $enseignant->degree > 30) {
                                                  echo 'bg-gradient-warning';
                                                }
                                                if ($enseignant->degree >= 30 && $enseignant->degree < 90) {
                                                  echo 'bg-gradient-info';
                                                }
                                                if ($enseignant->degree >= 90) {
                                                  echo 'bg-gradient-success';
                                                } ?>" role="progressbar" aria-valuenow="${enseignant.degree} " aria-valuemin="0" aria-valuemax="100" style="width: ${enseignant.degree}%;">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                      <p class="text-xs font-weight-bold mb-0">${enseignant.nbr_chaise}</p>
                                    </td>
                                    <?php if ($result->est_connecte === 0) { ?>
                                      <td class="align-middle text-center text-sm">
                                        <span class="badge badge-sm bg-gradient-secondary">Offline</span>
                                    ...
                                    <?php } ?>
                                    <td class="align-middle text-center text-sm">
                                      <p class="text-xs font-weight-bold mb-0">${enseignant.date_embauche}</p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                      <p class="text-xs font-weight-bold mb-0">${enseignant.salaire}</p>
                                    </td>
                                    <td class="align-middle text-center">
                                      <div class="">
                                        <div class="dropdown">
